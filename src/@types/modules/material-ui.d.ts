...
declare namespace MaterialUI {
  ...
  class Component<P, C = Object> extends React.Component<P & MaterialComponentProps<C>> {}
...
declare module "material-ui" {
  ...
  export { default as BottomNavigation, BottomNavigationButton } from "material-ui/BottomNavigation"

  export { default as Button } from "material-ui/Button"

  export { default as Card, CardActions, CardContent, CardHeader, CardMedia } from "material-ui/Card"

  export { default as Checkbox } from "material-ui/Checkbox"
  export { default as Chip } from "material-ui/Chip"

  export { default as Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from "material-ui/Dialog"

  export { default as Divider } from "material-ui/Divider"
  export { default as Drawer } from "material-ui/Drawer"

  export { FormControl, FormGroup, FormLabel, FormHelperText, FormControlLabel } from "material-ui/Form"
  ...
  export { default as Table, TableBody, TableCell, TableHead, TableRow, TableSortLabel } from "material-ui/Table"
...
declare module "material-ui/BottomNavigation/BottomNavigation" {
  ...
  export default class BottomNavigation extends MaterialUI.Component<BottomNavigationProps> {}
}
...
declare module "material-ui/BottomNavigation/BottomNavigationButton" {
  ...
  export default class BottomNavigationButton extends MaterialUI.Component<BottomNavigationButtonProps> {}
}
...
declare module "material-ui/Card/CardActions" {
  ...
  export default class CardActions extends MaterialUI.Component<CardActionsProps> {}
}

declare module "material-ui/Card/CardContent" {
  export interface CardContentProps {}

  export default class CardContent extends MaterialUI.Component<CardContentProps> {}
}
...
declare module "material-ui/Card/CardHeader" {
  ...
  export default class CardHeader extends MaterialUI.Component<CardHeaderProps> {}
}
...
declare module "material-ui/Dialog/DialogActions" {
  ...
  export default class DialogActions extends MaterialUI.Component<DialogActionsProps> {}
}

declare module "material-ui/Dialog/DialogContent" {
  export interface DialogContentProps {}

  export default class DialogContent extends MaterialUI.Component<DialogContentProps> {}
}

declare module "material-ui/Dialog/DialogContentText" {
  export interface DialogContentTextProps {}

  export default class DialogContentText extends MaterialUI.Component<DialogContentTextProps> {}
}
...
declare module "material-ui/Dialog/DialogTitle" {
  ...
  export default class DialogTitle extends MaterialUI.Component<DialogTitleProps> {}
}
...
declare module "material-ui/Form/FormControl" {
  ...
  export default class FormControl extends MaterialUI.Component<FormControlProps> {}
}
...
declare module "material-ui/Form/FormControlLabel" {
  ...
  export default class FormControlLabel extends MaterialUI.Component<FormControlLabelProps> {}
}
...
declare module "material-ui/Form/FormHelperText" {
  ...
  export default class FormHelperText extends MaterialUI.Component<FormHelperTextProps> {}
}
...
declare module "material-ui/Grid/Grid" {
  ...
  export type GridJustification = "flex-start" | "center" | "flex-end" | "space-between" | "space-around"
...
declare module "material-ui/IconButton/IconButton" {
  ...
  export default class IconButton extends MaterialUI.Component<IconButtonProps> {}
}

declare module "material-ui/Input"

declare module "material-ui/Input/Input" {
  export interface InputProps extends Partial<MaterialUI.InputEventEmitter<HTMLElement>> {
    autoComplete?: string
    autoFocus?: boolean
    component?: React.ReactNode
...
declare module "material-ui/Input/InputLabel" {
  ...
  export default class InputLabel extends MaterialUI.Component<InputLabelProps> {}
}
...
declare module "material-ui/List/ListItemAvatar" {
  ...
  export default class ListItemAvatar extends MaterialUI.Component<ListItemAvatarProps> {}
}

declare module "material-ui/List/ListItemIcon" {
  export interface ListItemIconProps {}

  export default class ListItemIcon extends MaterialUI.Component<ListItemIconProps> {}
}

declare module "material-ui/List/ListItemSecondaryAction" {
  export interface ListItemSecondaryActionProps {}

  export default class ListItemSecondaryAction extends MaterialUI.Component<ListItemSecondaryActionProps> {}
}
...
declare module "material-ui/List/ListItemText" {
  ...
  export default class ListItemText extends MaterialUI.Component<ListItemTextProps> {}
}
...
declare module "material-ui/List/ListSubheader" {
  ...
  export default class ListSubheader extends MaterialUI.Component<ListSubheaderProps> {}
}
...
declare module "material-ui/MobileStepper/MobileStepper" {
  ...
  export default class MobileStepper extends MaterialUI.Component<MobileStepperProps> {}
}
...
declare module "material-ui/Progress/CircularProgress" {
  ...
  export default class CircularProgress extends MaterialUI.Component<CircularProgressProps> {}
}
...
declare module "material-ui/Progress/LinearProgress" {
  ...
  export default class LinearProgress extends MaterialUI.Component<LinearProgressProps> {}
}
...
declare module "material-ui/Radio/RadioGroup" {
  ...
  export default class RadioGroup extends MaterialUI.Component<RadioGroupProps> {}
}
...
declare module "material-ui/Snackbar/SnackbarContent" {
  ...
  export default class SnackbarContent extends MaterialUI.Component<SnackbarContentProps> {}
}
...
declare module "material-ui/Table/TableSortLabel" {
  ...
  export default class TableSortLabel extends MaterialUI.Component<TableSortLabelProps> {}
}
...
declare module "material-ui/Tabs/Tab" {
  export interface TabProps {
    ...
    index?: number
    label?: React.ReactNode
    onChange?: (event: React.ChangeEvent<{ checked: boolean }>, index: number) => void
    onClick?: React.EventHandler<any>
    selected?: boolean
    style?: object
...
declare module "material-ui/Tabs/TabIndicator" {
  ...
  export default class TabIndicator extends MaterialUI.Component<TabIndicatorProps> {}
}
...
declare module "material-ui/Tabs/TabScrollButton" {
  ...
  export default class TabScrollButton extends MaterialUI.Component<TabScrollButtonProps> {}
}
...
declare module "material-ui/Typography/Typography" {
  ...
  export default class Typography extends MaterialUI.Component<TypographyProps> {}
}
...
declare module "material-ui/internal/ButtonBase" {
  ...
  export default class ButtonBase extends MaterialUI.Component<ButtonBaseProps> {}
}
...
declare module "material-ui/styles" {
  ...
  export { default as createStyleSheet } from "material-ui/styles/createStyleSheet"
...
declare module "material-ui/styles/breakpoints" {
  ...
  function createBreakpoints(options?: Partial<BreakpointsOptions>): Breakpoints
...
declare module "material-ui/styles/mixins" {
  ...
  export default function createMixins(breakpoints: Breakpoints, spacing: Spacing): Mixins
}
...
declare module "material-ui/styles/palette" {
  ...
  export default function createPalette(options?: Partial<PaletteOptions>): Palette
}
...
declare module "material-ui/styles/theme" {
  ...
  export default function createMuiTheme<T = {}>(options?: Partial<ThemeOptions> & T): Theme<T>
}
...
declare module "material-ui/styles/transitions" {
  ...
  export interface Transitions {
    easing: Easing
    duration: Duration
    create(props: string | string[], options?: Partial<{ duration: number; easing: string; delay: number }>): string
...
declare module "material-ui/styles/typography" {
  ...
  function createTypography(palette: Palette, constants?: FontStyle): Typography
...
declare module "material-ui/styles/withStyles" {
  ...
  ) => (component: React.ComponentType<P & { classes: ClassNames }>) => React.ComponentClass<P>
...
declare module "material-ui/test-utils" {
  export { default as createShallow } from "material-ui/test-utils/createShallow"
...
declare module "material-ui/test-utils/createRender" {
  ...
  export default function createRender(options?: Partial<RenderOptions>): typeof render & { cleanUp: Function }
}
...
declare module "material-ui/test-utils/until" {
  ...
  export default function until<P = any, S = any>(selector: string, options: { context: Object }): CommonWrapper<P, S>
}
...
declare module "material-ui/utils/withWidth" {
  ...
  export function isWidthUp(breakpoint: Breakpoint, screenWidth: number, inclusive?: boolean): boolean

  export default function withWidth<P = {}>(
    options?: WithWidthOptions
  ): (component: React.ComponentType<P>) => React.ComponentClass<P & WithWidthEnhancement>
}
